...
Patches that change Bitcoin LE consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitcoin LE consensus, it must have been
...
The project leader is the release manager for each Bitcoin LE Core release.
