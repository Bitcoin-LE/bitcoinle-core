...
%attr(0644,root,root) %{_mandir}/man1/bitcoinle-qt.1*
%endif
...
%attr(0644,root,root) %{_mandir}/man1/bitcoinled.1*

%files utils
%defattr(-,root,root,-)
%license COPYING
%doc COPYING bitcoin.conf.example doc/README.md
%attr(0755,root,root) %{_bindir}/bitcoinle-cli
%attr(0755,root,root) %{_bindir}/bitcoinle-tx
%attr(0755,root,root) %{_bindir}/bench_bitcoin
%attr(0644,root,root) %{_mandir}/man1/bitcoinle-cli.1*
