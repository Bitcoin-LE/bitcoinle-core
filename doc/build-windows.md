...
The options known to work for building Bitcoin LE Core on Windows are:
...
Note that for WSL the Bitcoin LE Core source path MUST be somewhere in the default mount file system, for
