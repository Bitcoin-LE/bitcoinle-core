...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bitcoinle-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bitcoinle-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinle transaction") + "\n" +
              "  bitcoinle-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinle transaction") + "\n" +
              "\n";
