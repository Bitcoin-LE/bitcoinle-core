...
{
    const char* pszTimestamp = "The Sydney Morning Herald 17/Feb/2018 Where to celebrate the Year of the Dog in Sydney";
...
public:
    CMainParams() {
		...
		consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000000000000a7fce50d4d3");

        // By default assume that the signatures in ancestors of this block are valid.
		consensus.defaultAssumeValid = uint256S("0x00000000a68c2e107aeca7a79fd52ccb76c6d5ce7c9340f1fd253782f6dac64f"); //0
        ...
        checkpointData = (CCheckpointData) {
            {
				{ 50048, uint256S("0x000000e810884e5f5d17d3b8f1d2af1c4d27d3e47d885ca0592a1d4418391293")}
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 14 * 24 * 60 * 60; // two weeks
        consensus.nPowTargetSpacing = 630;
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nRuleChangeActivationThreshold = 1440; // 75% for testchains
        consensus.nMinerConfirmationWindow = 1920; // nPowTargetTimespan / nPowTargetSpacing
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].bit = 28;
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nStartTime = 1199145601; // January 1, 2008
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008
        ...
        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000000032bb850ca20");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x00000000ad05d6cc13f9704c3bd1064bae515b3b076132a69f16d951e0185b72"); //70827
