This directory contains integration tests that test bitcoinled and its
...
bitcoinled processes running on the system, so should not be used if any non-test
bitcoinled processes are being run.**
...
gdb /home/example/bitcoinled <pid>
```
